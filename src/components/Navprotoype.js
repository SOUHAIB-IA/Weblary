...
import myImage from '../assites/log.png';
...
useEffect(() => {
  ...
  return (
    <React.Fragment  >
    <link rel="icon" type="image/png" sizes="32x32" href="./assets/images/favicon.png"></link>
        ...
        <nav className="navbar container div1">
            ...
            <div className="menu" id="menu">
                <ul className="list">
                    ...
                    <li><Link to="/review"><button className="button "><span>Sign In</span></button></Link></li>
                <li><Link to="/review"><button className="button "><span>Sign Up</span></button></Link></li>
                </ul>
            </div>
    ...
    <div className="search-form-container container" id="search-form-container">
        ...
        <div className="form-container-inner">
            ...
            <form action="" className="form">
                <input className="form-input" type="text" placeholder="What are you looking for?"></input>
